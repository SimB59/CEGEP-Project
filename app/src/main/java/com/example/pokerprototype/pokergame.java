...
public class pokergame extends AppCompatActivity {
            ...
            public void run() {
                ...
                while (players[0].getBalance()>0) { //One execution of this loop represents one full round.
                                ...
                                if (thePlayer.isRealPlayer()) { //If the player to play is real
                                    ...
                                    confirmBttn.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            if (iRaised >= thePlayer.getBalance()){
                                                setTextRaise(currentPlayer, thePlayer.getBalance());
                                                updateBalance(thePlayer, -thePlayer.getBalance(), table);
                                                thePlayer.setAllIn(true);
                                            }
                                            else if (iRaised > minRaiseNeeded) { //If the amount entered is greater than the actual highest bet, sets its bet to this amount and update balance.
                                                updateBalance(thePlayer, -iRaised, table);
                                                setTextRaise(currentPlayer, iRaised-minRaiseNeeded);
                                            }
                                            else if (iRaised == minRaiseNeeded) { //If the amount entered is the as the call, sets its bet to this amount and update balance.
                                                check(players, playersInRound, thePlayer, table);
                                                playersToPlay.remove(thePlayer);
                                                thePlayer.setdidSomething(true);
                                                setTextCall(currentPlayer);
                                                disableRealPlayerOptions();
                                                ...
                                                setTextRaise(currentPlayer, iRaised);
                                            }
                                            playersToPlay.clear();
                                            for (int i = 0; i < playersInRound.size(); i++) {
                                    ...
                                    int[] dec = Bot.takeDecision(thePlayer, table, turn, highestBet);
                                    decision=dec[0];
                                    int amount = dec[1];

                                    //0=Fold
                                    if (decision == 0) {
                                        if(highestBet<=thePlayer.getBetAmount()){
                                            check(players, playersInRound, thePlayer, table);
                                            setTextCheck(currentPlayer);
                                            playersToPlay.remove(thePlayer);
                                            thePlayer.setdidSomething(true);
                                    ...
                                    //Raise
                                        ...
                                        if (thePlayer.getBalance() > highestBet) {
                                            updateBalance(thePlayer, -amount - minRaiseNeeded, table);
                                            setTextRaise(currentPlayer, amount);
                                            playersToPlay.clear();
                                            for (int i = 0; i < playersInRound.size(); i++) {
                                                if (!players[playersInRound.get(i).getNumber()].isAllIn() && playersInRound.get(i) != thePlayer) {
                                                    playersToPlay.add(playersInRound.get(i));
                                            ...
                                            System.out.println("Bot #" + currentPlayer + " has raised!");
                                        }
                                        else {
                                            setTextFold(currentPlayer);
                                            playersToPlay.remove(thePlayer);
                    ...
                    if (!isEndOfTurn){
                        ...
                        if(winners.size()==1){
                            showTextWinner(winners.get(0).getNumber());
                        }
                        else{
    ...
    public void check(Player[] players, ArrayList<Player> playersInRound, Player player, Table table){
        ...
        if(player.getBetAmount()<highestBet){
            ...
            setTextCall(player.getNumber());
        }
        else{
            setTextCheck(player.getNumber());
        }
    ...
    public void setTextTurnPlayer(){
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                turnBot1.setText(null);
                turnBot2.setText(null);
                turnBot3.setText(null);
            }
        });
    }

    public void setTextFold(int numPlayer){
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                switch (numPlayer){
                    case 0:
                        turnPlayer.setText("Fold");
                        turnPlayer.setVisibility(View.VISIBLE);
                        break;
                    case 1:
                        turnBot1.setText("Fold");
                        turnBot1.setVisibility(View.VISIBLE);
                        break;
                    case 2:
                        turnBot2.setText("Fold");
                        turnBot2.setVisibility(View.VISIBLE);
                        break;
                    case 3:
                        turnBot3.setText("Fold");
                        turnBot3.setVisibility(View.VISIBLE);
                        break;
                }
            }
    ...
    public void setTextCheck(int numPlayer){
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                switch (numPlayer){
                    case 0:
                        turnPlayer.setText("Check");
                        turnPlayer.setVisibility(View.VISIBLE);
                        break;
                    case 1:
                        turnBot1.setText("Check");
                        turnBot1.setVisibility(View.VISIBLE);
                        break;
                    case 2:
                        turnBot2.setText("Check");
                        turnBot2.setVisibility(View.VISIBLE);
                        break;
                    case 3:
                        turnBot3.setText("Check");
                        turnBot3.setVisibility(View.VISIBLE);
                        break;
                }
            }
    ...
    public void setTextCall(int numPlayer){
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                switch (numPlayer){
                    case 0:
                        turnPlayer.setText("Call");
                        turnPlayer.setVisibility(View.VISIBLE);
                        break;
                    case 1:
                        turnBot1.setText("Call");
                        turnBot1.setVisibility(View.VISIBLE);
                        break;
                    case 2:
                        turnBot2.setText("Call");
                        turnBot2.setVisibility(View.VISIBLE);
                        break;
                    case 3:
                        turnBot3.setText("Call");
                        turnBot3.setVisibility(View.VISIBLE);
                        break;
                }
            }
    ...
    public void setTextRaise(int numPlayer, int amount){
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                switch (numPlayer){
                    case 0:
                        turnPlayer.setText("Raise by "+amount);
                        turnPlayer.setVisibility(View.VISIBLE);
                        break;
                    case 1:
                        turnBot1.setText("Raise by "+amount);
                        turnBot1.setVisibility(View.VISIBLE);
                        break;
                    case 2:
                        turnBot2.setText("Raise by "+amount);
                        turnBot2.setVisibility(View.VISIBLE);
                        break;
                    case 3:
                        turnBot3.setText("Raise by "+amount);
                        turnBot3.setVisibility(View.VISIBLE);
                        break;
                }
            }
